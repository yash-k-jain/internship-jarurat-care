    ...
    <div className="container my-2">
      <div className="container bg-warning" style={{ color: "white" }}>
        <h1 style={{ padding: "3rem" }}>
          ...
          <span style={{ color: "red", padding: "4rem" }}>
            A website which keeps your health services and allow others to apply
      ...
      <div className="container px-4 py-5" id="featured-3">
        ...
        <div className="row g-4 py-5 row-cols-1 row-cols-lg-3">
          ...
          <div className="feature col">
            <div className="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3"></div>
            <h3 className="fs-2 text-body-emphasis">Service Editing</h3>
            <p>Intuitive Service creation and editing interface.</p>
          </div>
          <div className="feature col">
            <div className="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3"></div>
            <h3 className="fs-2 text-body-emphasis">Security</h3>
            <p>End-to-end encryption for data security.</p>
          </div>
          <div className="feature col">
            <div className="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3"></div>
            <h3 className="fs-2 text-body-emphasis">Scalability</h3>
            <p>
              Design the system to handle a growing number of users and services
              efficiently.
            </p>
          </div>
        </div>
